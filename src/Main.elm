        ...
        [ div
            ...
            [ div
                ...
                [ form [ onSubmit AddTodo ]
                    [ input [ class "w-full px-4 py-4 shadow-sm focus:outline-none", value model.todo, placeholder "Add a todo...", onInput InputChanged ] []
                    ]
            ...
            , div [ class "mt-2 text-center text-sm text-gray-800" ]
                ...
                , div [ class "text-xs" ]
                    ...
                    , text " and "
                    , link "https://www.supabase.io/" "Supabase"
                    ]
                ]
            ]
        ]
            ...
            let
                updateTodo todo =
                    if todo.id == todoId then
                        ...
                        todo
            in
            ( model, switchStatus { id = todoId, status = "checked" } )
...
toggleStatus : TodoStatus -> TodoStatus
toggleStatus status =
    case status of
        Checked ->
            Unchecked
...
port switchStatus : { id : String, status : String } -> Cmd msg
